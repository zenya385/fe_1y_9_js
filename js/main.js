...
// const numbers = [24, 59, 78, 369, 15, 95, 45, 2];
...
//   }
// }
// console.log('smallNamber:>>', smallNumber);
...
// const arr = ['Mango', 'Ajax', 'Poly', 'Kiwi'];
// let word = '';
...
for (const letter of string) {
  if (letter === letter.toLocaleUpperCase()) {
    // console.log('Це велика літера:>>', letter);
    invertedString += letter.toLocaleLowerCase();
  } else {
    // console.log('Це маленька літера:>>', letter);
